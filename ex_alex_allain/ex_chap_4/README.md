...
Practice problems 
1. Ask for two users' ages, and indicate who is older; behave differently if both are over 100

2. Implement a simple "password" system that takes a password in the form of a number. Make it so that either of two numbers is valid, but use only one if statment to do the check
